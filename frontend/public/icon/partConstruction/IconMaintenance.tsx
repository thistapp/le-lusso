...
const IconMaintenance = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg
            width="24"
            height="24"
        ...
        >
            <path
                d="M21.6698 18.17L16.3698 12.87H15.3798L12.8398 15.41V16.4L18.1398 21.7C18.5298 22.09 19.1598 22.09 19.5498 21.7L21.6698 19.58C22.0598 19.2 22.0598 18.56 21.6698 18.17ZM18.8398 19.59L14.5998 15.35L15.3098 14.64L19.5498 18.88L18.8398 19.59Z"
                stroke="currentColor"
                fill="none"
            />
            <path
