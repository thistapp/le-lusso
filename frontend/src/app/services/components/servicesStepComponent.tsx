...
import DisplayDetailStep from './step/displayDetailStep'
...
const ServicesStepComponent: React.FC<Props> = ({ ...props }) => {
    return (
        // ถ้าแก้ขนาดแก้จาก 40 เป็น 20s
        <div className="w-full flex md:flex-row flex-col relative max-h-[30rem] h-full">
