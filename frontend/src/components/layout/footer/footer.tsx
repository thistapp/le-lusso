                ...
                <div className="hidden lg:grid grid-cols-12">
                    <div className="col-start-2 col-span-5">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="px-6">
                                © 2024 Le Lusso Project All Rights Reserved
                            </div>
                        </div>
                    </div>
                    <div className="col-span-5 content-end">
                        <div className="flex flex-col justify-end text-base gap-2">
                            <div className="w-3/12 flex flex-wrap text-right self-end">
                                <div>
                                    <span className="">23/71</span>
                                    <span className="mx-2">
                                        Thung Khru ,Thung Khru Bangkok
                                    </span>
                            ...
                            <div className="w-full flex flex-wrap justify-end gap-4 my-2">
                                <Link
                                    href={
                                        'https://www.facebook.com/profile.php?id=61565474234203'
                                    }
                                    target="_blank"
                                >
                                    <Image
                                ...
                                <Link
                                    href={
                                        'https://www.instagram.com/lelusso.official/'
                                    }
                                    target="_blank"
                                >
                                    <Image
                                ...
                                <Link
                                    href={
                                        'https://www.tiktok.com/@lelusso.project'
                                    }
                                    target="_blank"
                                >
                                    <Image
